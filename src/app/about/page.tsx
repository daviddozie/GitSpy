...
function About() {
    ...
    return (
        <div className="lg:w-[70%] md:w-[80%] w-[95%] mx-auto">
            <Header />
            <p className="text-[#8798bb] text-[16px] font-medium font-mono mt-[100px]">GitSpy is a simple and efficient GitHub user search tool that allows developers to quickly find GitHub profiles and access key user information such as repositories, followers, and bio details.</p>
            <h1 className="text-[#C2C6CE] font-momo font-bold text-[24px] pt-[50px] pb-[10px]">How it Works:</h1>
            <ul className="text-[#8798bb] font-medium text-base font-mono list-disc pl-3">
